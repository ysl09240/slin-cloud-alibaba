...
package com.slincloud.admin.biz.config;


import com.slincloud.common.core.constant.CacheConstants;
import com.slincloud.common.core.constant.SecurityConstants;
import com.slincloud.common.security.service.AdminUser;
import com.slincloud.common.security.service.MyClientDetailsService;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	public void configure(ClientDetailsServiceConfigurer clients) {
		//默认只保存到数据库，官方提供了数据库脚本，这里实现自已的，保存数据库的同时，添加到redis
	...
	public TokenEnhancer tokenEnhancer() {
		return (accessToken, authentication) -> {
			...
			AdminUser pigUser = (AdminUser) authentication.getUserAuthentication().getPrincipal();
