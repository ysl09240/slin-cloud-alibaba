...
package com.slincloud.common.security.component;
...
import com.slincloud.common.core.exception.MyDeniedException;
...
public class MyAccessDeniedHandler extends OAuth2AccessDeniedHandler {
	...
	public void handle(HttpServletRequest request, HttpServletResponse response, AccessDeniedException authException) {
		...
		R<MyDeniedException> result = R.failed(new MyDeniedException("授权失败，禁止访问"));
